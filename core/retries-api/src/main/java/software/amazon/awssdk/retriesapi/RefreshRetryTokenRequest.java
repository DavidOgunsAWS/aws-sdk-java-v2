...
public interface RefreshRetryTokenRequest {
    ...
    /**
     * A suggestion of how long to wait from the last attempt failure. For HTTP calls,
     * this is usually extracted from a "retry after" header from the downstream service.
     */
